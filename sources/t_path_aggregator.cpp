...
t_fs_path t_common_paths::get_fs_path_for_photo(const t_peer_id peer_id, const t_photo_bundle_id& photo_bundle, const t_fs_filename& filename) const {
    return get_fs_path_for_photo(peer_id) / photo_bundle.to_string() / filename;
}
...
void test_path() {
    ...
    test_path__get_fs_path_for_avatar(path, peer_id, t_avatar_type::t_default_avatar, "avatar.jpg", "/messenger/1000/9999/avatars/default/avatar.jpg");
    test_path__get_fs_path_for_avatar(path, peer_id, t_avatar_type::t_squared_avatar, "avatar.jpg", "/messenger/1000/9999/avatars/squared/avatar.jpg");
