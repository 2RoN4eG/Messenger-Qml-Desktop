...
t_fs_path t_common_paths::get_fs_path_for_avatar(const t_peer_id peer_id, const t_avatar_types avatar_type) const {
    return get_fs_path_for_avatar(peer_id) / to_string(avatar_type);
}

t_fs_path t_common_paths::get_fs_path_for_avatar(const t_peer_id peer_id, const t_avatar_types avatar_type, const t_fs_filename& filename) const {
...
void test_path__get_fs_path_for_avatar(const i_avatar_path& avatar_path, const t_peer_id peer_id, const t_avatar_types avatar_type, const t_fs_filename& filename, const t_fs_path& must_be = {}) {
...
void test_path() {
    ...
    test_path__get_fs_path_for_avatar(path, peer_id, t_avatar_types::t_default_avatar, "avatar.jpg", "/messenger/1000/9999/avatars/default/avatar.jpg");
    test_path__get_fs_path_for_avatar(path, peer_id, t_avatar_types::t_squared_avatar, "avatar.jpg", "/messenger/1000/9999/avatars/squared/avatar.jpg");
