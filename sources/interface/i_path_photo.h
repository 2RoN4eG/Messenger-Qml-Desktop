...
public:
    ...
    [[maybe_unused]]
    virtual t_fs_path get_fs_path_for_photo(const t_peer_id peer, const t_photo_bundle_id& photo_bundle, const t_fs_filename& filename) const = 0;
};
