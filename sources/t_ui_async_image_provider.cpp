...
QQuickImageResponse* t_ui_async_image_provider::requestImageResponse(const QString &id, const t_qt_size& size) {
    t_ui_async_response_image* async_response = new t_ui_async_response_image(_image_storage, _path_holder, _image_info_storage, size);
