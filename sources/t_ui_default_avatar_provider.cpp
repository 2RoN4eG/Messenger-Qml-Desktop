...
t_ui_default_avatar_provider::t_ui_default_avatar_provider(const i_path_holder& path_holder,
...
QQuickImageResponse* t_ui_default_avatar_provider::requestImageResponse(const QString &id, const QSize &requested_size) {
    t_ui_async_avatar_creating_response* async_response = new t_ui_async_avatar_creating_response(_path_holder,
                                                                                                  _image_info_storage,
                                                                                                  _image_storage,
                                                                                                  requested_size);
