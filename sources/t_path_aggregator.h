...
{
public:
    t_path_aggregator(const t_fs_path& root, const t_peer_id& self);
...
class i_path_holder {
public:
    virtual t_fs_path operator()(const t_peer_id peer, const t_fs_filename& filename) const = 0;
};
...
public:
    ...
    t_fs_path operator()(const t_peer_id peer, const t_fs_filename& filename) const override { return _avatar_path_aggregator.get_fs_path_for_avatar(peer, _avatar_type, filename); }
...
public:
    ...
    t_fs_path operator()(const t_peer_id peer, const t_fs_filename& filename) const override { return _photo_path_aggregator.get_fs_path_for_photo(peer, filename); }
