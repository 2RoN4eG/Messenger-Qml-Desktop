...
public:
    ...
    // setting avatar component { url, thumb_hash } by t_peer_id and t_avatar_id
    ...
    // setting photo component { url, thumb_hash } by t_peer_id and t_photo_id
    ...
    virtual const t_fs_path get_image_fs_path(const i_image_fs_path_maker& path_maker, const t_image_id image_id) const = 0;
